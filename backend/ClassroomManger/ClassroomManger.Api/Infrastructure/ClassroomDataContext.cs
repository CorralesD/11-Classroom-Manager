using ClassroomManger.Api.Models;
using System;
...
namespace ClassroomManger.Api.Infrastructure
{
    public class ClassroomDataContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<ClassroomManger.Api.Models.Teacher> Teachers { get; set; }

        // Define what your relationships are (Model Relations)
